			...
			<div class="sticky">
				<aside class="app-sidebar sidebar-scroll">
					...
					<div class="main-sidemenu">
						<div class="main-sidebar-loggedin">
							<div class="app-sidebar__user">
								<div class="dropdown user-pro-body text-center">
									<div class="user-pic">
										<img src="{{asset('assets')}}/img/faces/aku.jpg" alt="user-img" class="rounded-circle mCS_img_loaded">
									</div>
									<div class="user-info">
										<h6 class=" mb-0 text-dark">Nenden Sri Meida</h6>
						...
						<ul class="side-menu ">
							<li class="slide">
								<a class="side-menu__item {{ request()->is('pelanggan')? 'active':'' }}" href="{{route('pelanggan.index') }}" title="Pelanggan"><i class="side-menu__icon fe fe-users"></i><span class="side-menu__label">Pelanggan</span></a>
							</li>
						</ul>

						<ul class="side-menu ">
							<li class="slide">
								<a class="side-menu__item {{ request()->is('produk')? 'active':'' }}" href="{{route('produk.index') }}" title="Produk"><i class="side-menu__icon fe fe-shopping-cart"></i><span class="side-menu__label">Produk</span></a>
							</li>
						</ul>

						<ul class="side-menu ">
							<li class="slide">
								<a class="side-menu__item {{ request()->is('penjualan')? 'active':'' }}" href="{{route('penjualan.index') }}" title="Penjualan"><i class="side-menu__icon fe fe-truck"></i><span class="side-menu__label">Penjualan</span></a>
							</li>
						</ul>

						<ul class="side-menu ">
							<li class="slide">
								<a class="side-menu__item {{ request()->is('penjualan')? 'active':'' }}" href="{{route('penjualan.index') }}" title="Penjualan"><i class="side-menu__icon fe fe-dollar-sign"></i><span class="side-menu__label">Detail Penjualan</span></a>
							</li>
						</ul>
